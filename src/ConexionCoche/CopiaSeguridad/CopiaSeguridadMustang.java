...
public class CopiaSeguridadMustang {
    ...
    try {
        BufferedWriter writer = new BufferedWriter(new FileWriter("C:/Users/juang/OneDrive/Escritorio/Trabajo_Prog_Final/CopiasSeguridad/copia_seguridad_fordMustang.txt", true));
